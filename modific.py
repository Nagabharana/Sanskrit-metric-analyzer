...
class Module1:
	def line_partition(self,f):
		...
		f.close()
		#letter1=['್']
		#letter2=['ಾ','ಿ','ೀ','ು','ೂ','ೃ','ೄ','ೆ','ೇ','ೈ','ೊ','ೋ','ೌ','ಂ','ಃ','ः']
		letter1=['्']
		...
		while i<len1 :
			...
			i=i+1
		with open("Akshara.txt","w",encoding='utf-8') as f:
...
class Module2:
	def laghu_guru(self,akshara_list):
		...
		g_letter=['आ', 'ऊ', 'ॠ', 'ऌ','ऐ','ओ','औ','ऑ','ा','ी','ू','ो','ॄ','ै','े','ं',':','ौ','ः','़ु','ಃ','ः']
...
class Module3:
	...
	def vrutta(self,akshara_list,lg_list,lg_dup) :
		...
		if tf == True :
			self.Print_Master(akshara_list,"रगणात्परतः नगणसगणो चेत् हलमुखी  नाम स्यात् |  ",0,lg_list,lg_dup)
			return True
		...
		if tf == True :
			self.Print_Master(akshara_list,"मगन सगणो, जगणः, गुरुः चेत् शिध्दविराट् नामस्यात् |   ",0,lg_list,lg_dup)
			return True
		...
		if tf == True :
			self.Print_Master(akshara_list,"नगणद्वय, मगणयगणद्वयैर्युता मालिनी स्यात् | ",0,lg_list,lg_dup)
			return True
	...
	def Print_Master(self,akshara_list,str1,ch,lg_list,lm) :
		...
		if (len(akshara_list))==0:
			f=open("Chandassu.txt",'w',encoding='utf-8')
			f.write("Invalid")
		elif ch==0:
